...
public class TableHandling extends Base{
	...
	//for table rows and column will be inside the tbody tag
		WebElement row3= driver.findElement(By.xpath("	//table[@id='dataTable']/tbody/tr[3]")); // to locate row
		System.out.println("3rd row");
		System.out.println("/n"+row3.getText());// to print the loacte
		//table[@id='dataTable']/tbody/tr[3]/td[2]
		
		WebElement col2= driver.findElement(By.xpath("	//table[@id='dataTable']/tbody/tr[3]/td[2]")); // to locate ro
		System.out.println("2nd col");
		System.out.println("/n"+col2.getText());// to print the loacte
	}
